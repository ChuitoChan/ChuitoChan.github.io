...
#### 格局评价
我并没有采用大神那么多指标，而是采用我之前玩2048的思路（虽然我之前玩的时候时不时会傻逼一下，然后就跪了）。大家玩过都知道最方便合并的格局就是将最大那个数保持在角落，并且沿S路线单调递减，也就下面两个图那样（以左上角为例）。<br>
    <img src="/img/2048_row.png" alt="横向S路线" title="横向S路线" width="300" /><img src="/img/2048_col.png" alt="纵向S路线" title="纵向S路线" width="300" />
<br>
